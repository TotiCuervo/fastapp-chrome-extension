...
const DataRender = ({ item }: { item: TotalData }) => {
    ...
    return (
        <div className="hover:bg-card hover:border-border cursor-pointer flex-nowrap rounded-lg border border-transparent px-2 py-1 shadow">
            <h1 className="truncate text-nowrap">{title}</h1>
            <p className="text-foreground/70 truncate text-nowrap text-sm">
